...
import dev.nandi0813.api.utilities.NumberUtil;
...
public abstract class ProfileStat {
    ...
    public ProfileStat(Profile profile) {
        ...
        this.config = this.getProfileFile();
    }
    ...
    public void setData(boolean save) {
        ...
        for (NormalLadder ladder : ZonePracticeApi.getInstance().getLadders()) {
    ...
    protected abstract YamlConfiguration getProfileFile();

    protected abstract void saveProfileFile();
    ...
    public void loadDefaultStats(NormalLadder ladder) {
        ...
        if (ladder.isRanked()) {
            this.setDivision(ZonePracticeApi.getInstance().getDivision(profile));
        }
    }
