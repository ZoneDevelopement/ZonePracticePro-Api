...
public class LadderStats {
    ...
    private int elo = ZonePracticeApi.getInstance().getDefaultElo();
    ...
    public void setData(String ladderName, boolean ranked) {
        ...
        if (ranked) {
            ...
            config.set("stats.ladder-stats." + ladderName + ".ranked.elo", elo != 0 ? elo : ZonePracticeApi.getInstance().getDefaultElo());
        }
    ...
    public void getData(String ladderName, boolean ranked) {
        ...
        if (ranked) {
            ...
            if (this.elo == 0) {
                this.elo = ZonePracticeApi.getInstance().getDefaultElo();
            }
        }
